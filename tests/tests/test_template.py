...
<link href="/static/pipeline/css/urls.css" rel="stylesheet" type="text/css" />''', template.render()) # noqa
    ...
    def test_crossorigin(self):
        ...
        self.assertEqual('<script type="text/javascript" src="/static/scripts_crossorigin.js" charset="utf-8" crossorigin="anonymous"></script>', template.render())  # noqa
    ...
    def test_sri_sha256(self):
        ...
        self.assertEqual('<script type="text/javascript" src="/static/scripts_sha256.js" charset="utf-8" integrity="%s"></script>' % hash_, template.render())  # noqa
    ...
    def test_sri_sha384(self):
        ...
        self.assertEqual('<script type="text/javascript" src="/static/scripts_sha384.js" charset="utf-8" integrity="%s"></script>' % hash_, template.render())  # noqa
    ...
    def test_sri_sha512(self):
        ...
        self.assertEqual('<script type="text/javascript" src="/static/scripts_sha512.js" charset="utf-8" integrity="%s"></script>' % hash_, template.render())  # noqa
...
class DjangoTest(TestCase):
    ...
    def test_crossorigin(self):
        rendered = self.render_template("""{% load pipeline %}{% javascript "scripts_crossorigin" %}""")  # noqa
        self.assertEqual('<script type="text/javascript" src="/static/scripts_crossorigin.js" charset="utf-8" crossorigin="anonymous"></script>', rendered)  # noqa

    def test_sri_sha256(self):
        rendered = self.render_template("""{% load pipeline %}{% javascript "scripts_sri_sha256" %}""")  # noqa
        hash_ = JinjaTest.get_integrity("scripts_sha256.js", "sha256")
        self.assertEqual('<script type="text/javascript" src="/static/scripts_sha256.js" charset="utf-8" integrity="%s"></script>' % hash_, rendered)  # noqa

    def test_sri_sha384(self):
        rendered = self.render_template("""{% load pipeline %}{% javascript "scripts_sri_sha384" %}""")  # noqa
        hash_ = JinjaTest.get_integrity("scripts_sha384.js", "sha384")
        self.assertEqual('<script type="text/javascript" src="/static/scripts_sha384.js" charset="utf-8" integrity="%s"></script>' % hash_, rendered)  # noqa

    def test_sri_sha512(self):
        rendered = self.render_template("""{% load pipeline %}{% javascript "scripts_sri_sha512" %}""")  # noqa
        hash_ = JinjaTest.get_integrity("scripts_sha512.js", "sha512")
        self.assertEqual('<script type="text/javascript" src="/static/scripts_sha512.js" charset="utf-8" integrity="%s"></script>' % hash_, rendered)  # noqa
